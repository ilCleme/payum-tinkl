...
class ActivateInvoiceTest extends TestCase
{
    ...
    {
        $rc = new \ReflectionClass(ActivateInvoice::class);
    ...
    {
        $this->getMockForAbstractClass(ActivateInvoice::class, [$phpType]);
    }
    ...
    {
        /** @var Generic $request */
        $request = $this->getMockForAbstractClass(ActivateInvoice::class, [123321]);
    ...
    {
        /** @var Generic $request */
        $request = $this->getMockForAbstractClass(ActivateInvoice::class, [$phpType]);
    ...
    public function shouldAllowGetTokenSetInConstructor()
    {
        ...
        /** @var Generic $request */
        $request = $this->getMockForAbstractClass(ActivateInvoice::class, [$tokenMock]);
    ...
    public function shouldConvertArrayToArrayObjectInConstructor()
    {
        ...
        /** @var Generic $request */
        $request = $this->getMockForAbstractClass(ActivateInvoice::class, [$model]);
    ...
    public function shouldNotSetTokenAsFirstModelOnConstruct()
    {
        ...
        $request = $this->getMockForAbstractClass(ActivateInvoice::class, [$token]);
    ...
    public function shouldNotSetIdentityAsFirstModelOnConstruct()
    {
        ...
        $request = $this->getMockForAbstractClass(ActivateInvoice::class, [$identity]);
    ...
    public function shouldNotSetTokenAsFirstModelOnSetModel()
    {
        ...
        /** @var Generic $request */
        $request = $this->getMockForAbstractClass(ActivateInvoice::class, [null]);
    ...
    public function shouldNotChangeFirstModelOnSecondSetModelCall()
    {
        ...
        /** @var Generic $request */
        $request = $this->getMockForAbstractClass(ActivateInvoice::class, [$firstModel]);
